------------------------------------UAT-----pubstrat non Sylogent emails----------------------------------
--
--
--

-----------------------------------------Database UAT_SYLOGENT_PUBSTRAT------------------------------

use [UAT_SYLOGENT_PUBSTRAT]

-- Database: RC_SYLOGENT_PUBSTRAT
-- Table: tblUser
-- Column: Email
-- Number of records affected: 27
--
...
--------------------UAT---------Database UAT_SYLOGENT_GATEKEEPER -------------------------
--

--
--
-- Database: UAT_SYLOGENT_GATEKEEPER
-- Table: Account
-- Column: email
-- Records affected: 5
--
